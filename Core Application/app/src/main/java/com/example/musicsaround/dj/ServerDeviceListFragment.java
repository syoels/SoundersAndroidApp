...
import com.example.musicsaround.User;
import com.example.musicsaround.usersDB;
		...
		PeerListListener, ConnectionInfoListener, Handler.Callback
{
	...
	private class WiFiPeerListAdapter extends ArrayAdapter<WifiP2pDevice>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent)
		{
            ...
            User currUser = db.getUserbyDevice(device.deviceName);
			...
			if (device != null)
			{
				...
				if (top != null)
				{
					top.setText(currUser.getUsername());
				}
				if (bottom != null)
				{
					...
					bottom.setText(currUser.getStationName());
                    ImageView icn = (ImageView) v.findViewById(R.id.icon);
                    Context c = this.getContext();
                    Resources r = c.getResources();
                    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    int icn_id = r.getIdentifier(currUser.getUserPic(), "drawable", c.getPackageName());
